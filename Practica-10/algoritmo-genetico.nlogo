...
to setup
  ...
  set salidas-red ["Avanzar" "Retroceder" "GirarDer" "GirarIzq" "OrientarseAlimento"]
  set generacion 0
  set radio 5
  set paso 0.5
...
;    export-view ( word ("img/basico/img-") (agregar-ceros (word ticks "") 4) (".png"))
    tick
  ]
...
to OrientarseAlimento [ x ]
  if x > 0 and any? alimentos in-cone radio 90
  [ face one-of alimentos in-cone radio 90 ]
end
...
"" ""
PENS
"default" 1.0 0 -16777216 true "" "plot count tortugas"
